...
public class BookDAO{
	...
	public void insertBook(Book book) {
		String query = "INSERT INTO `library`.`tbl_book` (`title`) VALUES (?);";
	...
	public Book getBookById(int bookId) {
		Book book = jdbcTemplate.queryForObject("SELECT * FROM library.tbl_book where bookId=?", new Object[] { bookId }, new BookRowMapper());
